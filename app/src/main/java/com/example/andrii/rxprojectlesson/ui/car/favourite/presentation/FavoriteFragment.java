...
public class FavoriteFragment
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.cars_favorite_fragment, container, false);
    }
    ...
    public void showCars(List<CarViewModel> listCars) {
        linearAdapter.setItems(listCars, new CarsLinearLayoutAdapter.CarItemCallback() {
            ...
            public void onFavoriteClick(int carId, boolean isFavorite, int adapterPosition) {
                presenter.onFavoriteButtonClick(carId, isFavorite, adapterPosition);
            }
        });
    ...
    @Override
    public void removeFromRecycler(int adapterPosition) {
        linearAdapter.removeItemsAtPosition(adapterPosition);
        gridAdapter.removeItemsAtPosition(adapterPosition);
        staggeredGridAdapter.removeItemsAtPosition(adapterPosition);
    }

    @Override
    public void cleanAdapters() {
        linearAdapter.clearItems();
        gridAdapter.clearItems();
        staggeredGridAdapter.clearItems();
    }
